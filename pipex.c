...
/*   Updated: 2025/05/08 19:07:39 by bde-koni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	change_program(char *cmd, char **envp) // "cat -e"
{
	...
	if (!full_path)
	{
		...
		// ft_putendl_fd("command not found\n", 2); // dont use perror because no system fail
		// exit(127); // 127: error code for command not found
	}
...
int	main(int argc, char **argv, char **envp)
{
	...
	// {
	// 	fd_putendl_fd("invalid amount of arguments\n", 2);
	// 	exit(2);
	// }
		// return (1);
